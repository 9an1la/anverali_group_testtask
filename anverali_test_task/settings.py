"""
Django settings for anverali_test_task project.
...
ROOT_URLCONF = 'anverali_test_task.urls'
...
WSGI_APPLICATION = 'anverali_test_task.wsgi.application'
